...
- Generate a "standard manuscript" formatted **ODF text document (ODT)** from an yWriter 7 project.
...
[Download the latest release (version 1.10.0)](https://raw.githubusercontent.com/peter88213/pywoo/master/dist/pywoo-1.10.0.oxt)
