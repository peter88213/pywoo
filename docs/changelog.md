...
Based on PyWriter version 12.13.1
...
Based on PyWriter version 7.11.3

### Version 1.31.5 Improvements
...
### Version 1.28.0 Consider quotations
...
### Version 1.26.0 Consider inline raw code
...
### Version 1.22.1 Optional update
...
### Version 1.22.0 Support quotations and lists
...
### Version 1.6.0 New document formatting, general program improvement
...
Based on PyWriter version 3.6.4
...
### Version 1.2.0 New user interface

- The main window is replaced by a simple message box.

Based on PyWriter version 3.2.0
...
Based on PyWriter version 2.16.1

### Version 0.36.6 Bugfix release
...
### Version 0.36.5 Prepare os-independent import from yWriter
...
### Version 0.36.1 Improve the processing of comma-separated lists
...
### Version 0.36.0 Export cross references
...
### Version 0.34.0 Fix a bug and add advanced features to the "Files" menu
...
### Version 0.32.4 Support ods spreadsheets
...
### Version 0.30.0 Underline and strikethrough no longer supported
